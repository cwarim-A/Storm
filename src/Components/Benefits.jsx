         ...
         <div className='flex flex-col md:flex-row lg:flex-row items-center justify-center md:gap-[15px] lg:gap-[50px] '>
            ...
            <div className='w-full lg:w-3/5'>
                  ...
                  <div className='flex flex-col gap-3 py-5'>
                      ...
                      <p className='text-[#797979] text-[12px] w-full md:w-[80%]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eius tempor incididunt ut labore et dolore magna aliqua. enim minim veniam</p>
                  </div>
