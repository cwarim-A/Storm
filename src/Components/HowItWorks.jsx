...
const HowItWorks = () => {
    return (
        <div className='bg-[#F5F9F7] h-[300px] relative '>
            <div className='bg-[#F0D22FED]  rounded-2xl flex flex-col md:flex-row divide-y-2  md:divide-x-2 md:divide-y-0 divide-[#7F56D9] py-5 md:py-10 absolute top-[30%] w-[90%] left-[5%] mb-10 '> 
                {
