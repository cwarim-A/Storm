...
const HowItWorks = () => {
    return (
        <div id="how-it-works" className='bg-[#F5F9F7] h-[300px] relative '>
            <div className='bg-[#F0D22FED]  rounded-2xl flex flex-col md:flex-row divide-y-2  md:divide-x-2 px-5 md:px-0 md:divide-y-0 divide-[#fff] py-5 md:py-5 lg:py-10 absolute top-[10%] md:top-[30%]  w-[90%] left-[5%] mb-10'> 
                {
