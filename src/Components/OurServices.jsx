...
const OurServices = () => {
  return (
      <div className='px-5 md:px-[130px] py-10 bg-[#F1D53E] h-[900px] md:h-[800px] lg:h-[500px] flex flex-col text-center items-center'>
          ...
          {/* <div className='flex flex-col md:flex-col md:flex-wrap  lg:flex-row  gap-5 items-center py-10'>
